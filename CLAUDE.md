...
This is a two-player Blokus Duo game with Nuxt 3 frontend and Convex backend.

### Frontend (app/)
- **pages/index.vue**: Home page with "Create Game" button
- **pages/game/[code].vue**: Main game page - contains all game logic, piece selection, placement preview, and controls
...
- **plugins/convex.client.ts**: Initializes Convex client from `NUXT_PUBLIC_CONVEX_URL`
...
4. Real-time sync via Convex's reactive `useConvexQuery`
